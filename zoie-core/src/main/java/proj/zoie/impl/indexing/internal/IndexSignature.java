...
public class IndexSignature<V extends ZoieVersion> {
	...
	public void save(OutputStream out) throws IOException {
		...
		try {
			...
			if (_version == null) {
				...
				// System.out.println("IndexSignature:save:_version: write " +
				// _version.encodeToString());
	...
	public static <V extends ZoieVersion> IndexSignature<V> read(
			InputStream in, ZoieVersionFactory<V> zoieVersionFactory)
			throws IOException {
