...
public class JDBCStreamDataProvider<T, V extends ZoieVersion> extends
		StreamDataProvider<T, V> {
	private static final Logger log = Logger
			.getLogger(JDBCStreamDataProvider.class);
	...
	public JDBCStreamDataProvider(JDBCConnectionFactory connFactory,
			PreparedStatementBuilder<T, V> stmtBuilder) {
