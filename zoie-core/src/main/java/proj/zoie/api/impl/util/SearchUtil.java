...
public class SearchUtil {
	 ...
	 * @param field
	 * @param query
	 * @return a String representation of the search result given the string
	 *         representations of query arguments.
	 */
	public static String search(Zoie zoie, String field, String query) {
		...
		parser = new QueryParser(Version.LUCENE_CURRENT, field,
				zoie.getAnalyzer());
	 ...
	 * @param zoie
	 * @param UID
	 * @return the a String representation of the Document(s) referred to by the
	 *         given UID
	 */
